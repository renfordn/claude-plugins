...
│   └── cache-dashboard.md            # Generate an HTML metrics dashboard
│
├── scripts/
...
2. **Explicit — CLI commands** (via `Bash`): `node "${CLAUDE_PLUGIN_ROOT}/scripts/cache-command.js" status|clear|config|dashboard`.
