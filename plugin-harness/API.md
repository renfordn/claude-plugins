# Plugin Harness API Reference

## Overview

The plugin-harness provides a type-safe, high-performance routing and handoff system for multi-agent workflows. The API consists of two main components:
