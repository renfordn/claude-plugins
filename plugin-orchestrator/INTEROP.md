# Plugin-Orchestrator: Hook Contracts & Capabilities
...
Plugin-orchestrator provides hooks for coordinating multi-agent workflows and ensuring all errors are observable.
